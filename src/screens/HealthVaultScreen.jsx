...
function DoctorTab({ reports, trends }) {
  ...
  function handleCopy() {
    const lines = [
      ...
      'Generated by AROGYOS — for medical reference only. Consult a qualified physician before any treatment decisions.',
    ].filter(Boolean).join('\n')
    ...
    <div className="hv-doctor">
      ...
      <div className="hv-doc-paper" id="hv-print-area">
        ...
        <div className="hv-dp-header">
          <div className="hv-dp-logo">🧬 AROGYOS</div>
        ...
        <div className="hv-dp-footer">
          <strong>⚕️ Medical Disclaimer:</strong> This document is generated by AROGYOS for educational reference and health tracking. It is not a medical diagnosis, prescription, or clinical report. All values should be interpreted by a qualified healthcare professional in the full clinical context of the patient. AROGYOS is not a medical device.
        </div>
      </div>
    </div>
  )
